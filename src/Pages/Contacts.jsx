...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-black-50   p-4  w-full ">
            <div className="m-4">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="text-3xl">Unable to Contact Please enter the contact using the<br/> Create Contact button.</h1>
            </div>}
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">

                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-purple-800 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-yellow-300 text-white">
